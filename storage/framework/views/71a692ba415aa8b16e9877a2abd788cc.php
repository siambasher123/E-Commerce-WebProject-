  ...
  <main class="ml-64 p-10 w-full animate-fadeInUp">
          ...
          <tbody class="text-gray-700 divide-y divide-gray-200">
            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr class="hover:bg-gray-50 transition">
                <td class="py-3 px-4"><?php echo e($p->id); ?></td>
                <td class="py-3 px-4"><?php echo e($p->category); ?></td>
                <td class="py-3 px-4"><?php echo e($p->subcategory); ?></td>
                <td class="py-3 px-4 font-semibold text-gray-900"><?php echo e($p->code); ?></td>
                <td class="py-3 px-4 text-indigo-600 font-semibold">$<?php echo e(number_format($p->price, 2)); ?></td>
                <td class="py-3 px-4"><?php echo e($p->stock); ?></td>
                <td class="py-3 px-4 truncate max-w-xs text-sm" title="<?php echo e($p->description); ?>">
                  <?php echo e(\Illuminate\Support\Str::limit($p->description, 50)); ?>
                ...
                <td class="py-3 px-4 text-center space-x-2">
                  ...
                  <form action="<?php echo e(route('admin.products.destroy', $p->id)); ?>" method="POST" class="inline-block"
    ...
    <section id="add-product" class="tab-content hidden">
      <div class="bg-white p-10 rounded-2xl shadow-2xl border border-gray-200 w-full">
        ...
        <form method="POST" action="<?php echo e(route('admin.products.store')); ?>" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\USER\eshop\resources\views/admin/products/index.blade.php ENDPATH**/ ?>