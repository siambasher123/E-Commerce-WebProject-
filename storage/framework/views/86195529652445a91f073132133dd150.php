...
<div class="max-w-7xl mx-auto px-6 py-12 flex flex-col lg:flex-row gap-8">
    ...
    <form method="GET" action="">
      ...
      <div class="mb-6">
        <label class="flex items-center space-x-2">
          <input type="checkbox" name="stock" value="1" <?php echo e(request('stock') ? 'checked' : ''); ?>
  ...
  <section class="flex-1">
    <h1 class="text-3xl font-bold text-gray-900 mb-6">
      <?php echo e($category); ?> › <?php echo e($subcategory); ?>
    ...
    <?php else: ?>
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <a href="<?php echo e(route('shop.product', $p->id)); ?>" 
          ...
          <div class="p-4">
            <h2 class="text-lg font-semibold text-gray-800 truncate"><?php echo e($p->subcategory); ?></h2>
            <p class="text-gray-600 text-sm mt-1 truncate"><?php echo e(Str::limit($p->description, 60)); ?></p>
            <div class="mt-3 flex items-center justify-between">
              <span class="text-indigo-600 font-bold">$<?php echo e(number_format($p->price, 2)); ?></span>
              <?php if($p->stock > 0): ?>
...
<footer class="bg-[#0d0d0d] text-gray-300 py-10 mt-16 text-center">
  <p class="text-sm">&copy; <?php echo e(date('Y')); ?> MyShop. All rights reserved.</p>
</footer>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\eshop\resources\views/client/shop/subcategory.blade.php ENDPATH**/ ?>