...
<body class="bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 text-gray-800">
  ...
  <?php if(session()->has('success')): ?>
    ...
    <div id="flash-message"
        ...
        <strong class="block font-semibold"><?php echo e($successMessage); ?></strong>
    ...
    <script>
      setTimeout(() => {
        ...
        setTimeout(() => window.location.href = "<?php echo e(route('login')); ?>", 800);
      }, 2000);
    </script>
  <?php endif; ?>
  ...
  <section class="min-h-screen flex items-center justify-center px-6 py-12">
    <div class="bg-white/80 backdrop-blur-lg p-10 rounded-3xl shadow-2xl w-full max-w-lg border border-gray-200 animate-fadeInUp transition-all duration-300 hover:shadow-3xl hover:scale-[1.02]">
      ...
      <!-- Signup Form -->
      <form method="POST" action="<?php echo e(route('register.post')); ?>" id="signupForm" class="space-y-5">
        <?php echo csrf_field(); ?>
      ...
      <p class="text-center text-sm text-gray-700 mt-6">
        ...
        <a href="<?php echo e(route('login')); ?>" class="text-indigo-600 font-medium hover:underline hover:text-indigo-700 transition">
          Login
        </a>
      </p>
    </div>
...
<?php /**PATH C:\Users\USER\eshop\resources\views/auth/register.blade.php ENDPATH**/ ?>