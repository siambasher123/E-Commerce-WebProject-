...
<div class="bg-gray-50 min-h-screen py-10 px-4 md:px-10">
  <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
      ...
      <div class="bg-white rounded-xl shadow-md overflow-hidden max-w-md w-full">
        ...
        <?php if(Str::startsWith($product->image, 'http')): ?>
          <img src="<?php echo e($product->image); ?>" 
               ...
               class="w-full h-[520px] object-cover object-center hover:scale-[1.02] transition-transform duration-300">
        <?php else: ?>
    ...
    <!-- 🧾 PRODUCT DETAILS -->
    <div>
      <h1 class="text-3xl font-semibold text-gray-900 mb-3"><?php echo e($product->subcategory); ?></h1>
      ...
      <!-- PRODUCT CODE -->
      <p class="text-gray-700 mb-1"><strong>Code:</strong> <?php echo e($product->code); ?></p>
      ...
      <!-- 🛒 ADD TO CART -->
      <form action="<?php echo e(route('cart.add', $product->id)); ?>" method="POST" class="mb-8">
        <?php echo csrf_field(); ?>
  ...
  <div class="max-w-7xl mx-auto mt-12">
    ...
    <div id="review" class="tab-content bg-white p-8 rounded-b-lg shadow mt-2 hidden">
      ...
      <div class="mt-6">
        <button class="border border-gray-400 text-gray-800 px-5 py-2 rounded-lg hover:bg-gray-100">
          ✏️ Write a Review
        </button>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\eshop\resources\views/client/shop/product.blade.php ENDPATH**/ ?>