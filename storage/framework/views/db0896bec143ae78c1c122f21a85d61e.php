        ...
        <nav class="hidden lg:flex space-x-6 font-medium text-gray-300 relative">
          ...
          <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat => $subs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group relative">
              <a href="<?php echo e(route('shop.category', ['category' => urlencode($cat)])); ?>" class="hover:text-white transition">
                <?php echo e($cat); ?>
...
>
        ...
        <!-- SEARCH BAR -->
        <form action="<?php echo e(route('find')); ?>" method="GET" class="relative hidden md:block w-64">
          <input 
            name="q" 
            type="text" 
    ...
    <div class="absolute top-3 right-6 flex items-center space-x-6">
      ...
      <a href="<?php echo e(route('contact.form')); ?>" 
  ...
  <section class="bg-gradient-to-r from-gray-100 to-gray-200 py-20">
    <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
      <div class="mb-10 md:mb-0">
        ...
        <a href="<?php echo e(route('shop.index')); ?>" class="bg-black text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition">
          Shop Now
        </a>
      </div>
  ...
  <section class="max-w-7xl mx-auto px-6 py-16">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
      ...
      ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$title,$img]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <a href="<?php echo e(route('shop.category', ['category' => urlencode($title)])); ?>" 
         class="relative group overflow-hidden rounded-xl shadow-md hover:shadow-xl transition">
        <img src="<?php echo e($img); ?>?auto=format&fit=crop&w=500&q=60" alt="<?php echo e($title); ?>"
             class="w-full h-64 object-cover group-hover:scale-110 transition">
        <div class="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition">
          <p class="text-white text-lg font-semibold"><?php echo e($title); ?></p>
        </div>
      </a>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<?php /**PATH C:\Users\USER\eshop\resources\views/home.blade.php ENDPATH**/ ?>